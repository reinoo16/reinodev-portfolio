...
function ProjectCard(props) {
    return (
        <div className='group flex flex-col gap-[24px] w-full'>
            <div className='relative w-full h-[360px] rounded-[30px] overflow-hidden'>
                <div className='absolute transition-all duration-300 group-hover:opacity-0 left-0 top-0 w-full z-20 h-full bg-black20'></div>
                <img className='w-full h-full object-center z-10 object-cover' src={props.img} alt="" />
            </div>
            <div className="flex flex-col gap-[18px] w-full">
                ...
                {
                    props.live ?
                        <a className='w-fit' target='_blank' href={props.live}>
